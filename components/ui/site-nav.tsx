  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-3 z-[var(--z-nav)] flex justify-center px-2 pb-[env(safe-area-inset-bottom,0px)] sm:bottom-4">
      <nav
        ...
        className={cn(
          "pointer-events-auto flex w-max max-w-[calc(100vw-1rem)] items-center gap-0.5",
          "rounded-2xl border border-border/60 bg-background/95 p-1 shadow-elevated backdrop-blur-sm",
